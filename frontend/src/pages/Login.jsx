...
function Login() {
  ...
  return (
    <>
      <div className='flex justify-center  items-center h-screen bg-white/10 fixed z-100 top-0 left-0 bottom-0 right-0'>
        <form id='form' onSubmit={handleSubmit} className='flex bg-black flex-col text-white space-y-2 shadow-2xl shadow-black  w-[300px] h-[350px] border-white border-1   max-w-[300px]:w-full  px-5 py-5 rounded-md'>
